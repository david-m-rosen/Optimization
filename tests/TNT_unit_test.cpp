...
//  // Input vector  g -- right-hand side of the equation Hv = -g we're trying
//  to
...
//    /// Termination criteria for the Steihaug-Toint truncated conjugate
//    gradient
//    /// solver
...
//  /// and an *exact* stopping criterion and an infinite trust region radius,
//  to
...
//  // Since N is negative-definite, the negative-curvature-handling subroutine
//  of
//  // the STPCG method should compute a solution that moves in the direction of
//  // -g all the way to the boundary of the trust-region radius (i.e., until
//  its
//  // norm is Delta)
...
//  Scalar V_truncated_M_norm = std::sqrt(V_truncated.dot(small_M *
//  V_truncated)); Scalar V_truncated_norm_error = fabs(update_step_norm -
//  V_truncated_M_norm);
...
//  Scalar V_truncated_M_norm = std::sqrt(V_truncated.dot(large_M *
//  V_truncated)); Scalar V_truncated_norm_error = fabs(update_step_norm -
//  V_truncated_M_norm);
